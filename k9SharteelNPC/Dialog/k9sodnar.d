...
++ ~Ye bunch of natty clapperdogeon couldn't run the game if ye had ten eyes and the stalks to match. Where be Alatos at? I have business with him.~  GOTO 2
...
++ ~Damn ye and damn yer guild! A friend be stuck in the jailhouse and I be looking to free the coot. Riches ta those who help with the deed, true as a word. What say ye? Yay or neigh?~ GOTO 4
++ ~I'll be to the point then. I need you to forge official documentation from Duke Eltan that approves the release of a prisoner into my custody.~ GOTO 5
END
...
IF ~~ THEN BEGIN 5
SAY ~Ho! tis a fine man known that'll do what ye want. Bring me a hundred gold and the paper and I'll see it through.~ IF  ~~ THEN DO ~SetGlobal("k9NarlenLoop","GLOBAL",1) SetGlobal("k9KnowsNarlen","GLOBAL",1) AddJournalEntry(@665568,QUEST) SetGlobal("k9narlenletter","GLOBAL",1)~ EXIT
END
      
IF ~Global("k9narlenletter","GLOBAL",1)~ THEN BEGIN 6
